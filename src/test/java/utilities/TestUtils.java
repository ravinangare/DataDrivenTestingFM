...
public class TestUtils {
    ...
    public String getDriverPath(String browser){
        ...
        switch (browser.toLowerCase()){
            case "firefox": path= new String[]{"src","test","resources","executables", "Binary", "geckodriver.exe"};
                break;
            case "edge": path= new String[]{"src","test","resources","executables","Binary","msedgedriver.exe"};
                break;
            default: path= new String[]{"src","test","resources","executables", "Binary","Driver_Notes","chromedriver.exe"};
        }
